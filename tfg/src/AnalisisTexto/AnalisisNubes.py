...
def main():
    ...
    nubes = nubes[nubes['provincia']== 'TENERIFE']
    size = frecuenciaTemática(nubes.frase)
    print("La cantiad de frases de nubes en Tenerife es " + str(len(nubes)))
    print("La longitud de nubes en Tenerife es " + str(size))
    print("---------")
    
    
    datos = pd.DataFrame(total)
    nubes = datos[datos['clase']== 'nubes']
    nubes = nubes[nubes['provincia']== 'ALACANT/ALICANTE']
    size = frecuenciaTemática(nubes.frase)
    print("La cantiad de frases de nubes en Alicante es " + str(len(nubes)))
    print("La longitud de nubes en Alicante es " + str(size))
    print("---------")
    
    datos = pd.DataFrame(total)
    nubes = datos[datos['clase']== 'nubes']
    nubes = nubes[nubes['provincia']== 'LA RIOJA']
    size = frecuenciaTemática(nubes.frase)
    print("La cantiad de frases de nubes en LA RioJa es " + str(len(nubes)))
    print("La longitud de nubes en La RioJa es " + str(size))
    print("---------")
    
    datos = pd.DataFrame(total)
    nubes = datos[datos['clase']== 'nubes']
    nubes = nubes[nubes['provincia']== 'MADRID']
    size = frecuenciaTemática(nubes.frase)
    print("La cantiad de frases de nubes en Madrid es " + str(len(nubes)))
    print("La longitud de nubes en Madrid es " + str(size))
    print("---------")
   
   
    datos = pd.DataFrame(total)
    nubes = datos[datos['clase']== 'nubes']    
    buscarPalabras(nubes.frase,nlp)
    tokenizar(nubes.frase,nlp)
    print("La longitud de frase de nubes es: " + str(len(nubes)))
