...
def main():
    ...
    nieve = nieve[nieve['provincia']== 'TENERIFE']
    size = frecuenciaTemática(nieve.frase)
    print("La cantiad de frases de nieve en Tenerife es " + str(len(nieve)))
    print("La longitud de nieve en Tenerife es " + str(size))
    print("---------")
    
    
    datos = pd.DataFrame(total)
    nieve = datos[datos['clase']== 'nieve']
    nieve = nieve[nieve['provincia']== 'ALACANT/ALICANTE']
    size = frecuenciaTemática(nieve.frase)
    print("La cantiad de frases de nieve en Alicante es " + str(len(nieve)))
    print("La longitud de nieve en Alicante es " + str(size))
    print("---------")
    
    datos = pd.DataFrame(total)
    nieve = datos[datos['clase']== 'nieve']
    nieve = nieve[nieve['provincia']== 'LA RIOJA']
    size = frecuenciaTemática(nieve.frase)
    print("La cantiad de frases de nieve en LA RioJa es " + str(len(nieve)))
    print("La longitud de nieve en La RioJa es " + str(size))
    print("---------")
    
    datos = pd.DataFrame(total)
    nieve = datos[datos['clase']== 'nieve']
    nieve = nieve[nieve['provincia']== 'MADRID']
    size = frecuenciaTemática(nieve.frase)
    print("La cantiad de frases de nieve en Madrid es " + str(len(nieve)))
    print("La longitud de nieve en Madrid es " + str(size))
    print("---------")
   
   
    datos = pd.DataFrame(total)
    nieve = datos[datos['clase']== 'nieve']    
    buscarPalabras(nieve.frase,nlp)
    tokenizar(nieve.frase,nlp)
    print("La longitud de frase de nieve es: " + str(len(nieve)))
